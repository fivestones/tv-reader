#We're going to see if we can make this serve a webpage with the jpg images
#When done it shouldn't need tkinter at all
...
#wWidth and wHeight shoudld be changed to be the resolution of the screen for google chromecast or whatever we are using to display things
